...
(function($){
	...
	CODEXCODER.initialize = {
		...
		heroFullScreen: function() {
			...
			// $('.full-screen').css('min-height', window.innerHeight );

			// // Overlay Div Full Screen
			// $('.full-screen .overlay').css('min-height', window.innerHeight );
			
		},

		bannerHeightFix: function() {

			// $(".banner-section > div > .container").css("min-height", $(".banner-section").height());
			// $(".banner-section .application-mockup").css("min-height", $(".banner-section").height());
		},
